...
var onShowSignInBack = function onShowSignInBack(event) {
  event.preventDefault();
  $('#sign-in-form').hide();
  $('#show-sign-in').show();
  $('#show-sign-up').show();
...
var onShowSignUpBack = function onShowSignUpBack(event) {
  event.preventDefault();
  $('#sign-up-form').hide();
  $('#show-sign-up').show();
  $('#show-sign-in').show();
...
var onShowChangePasswordBack = function onShowChangePasswordBack(event) {
  event.preventDefault();
...
var onGoToLab = function onGoToLab(event) {
  event.preventDefault();
  viewState = 1;
  store.viewState = 1;
...
var onGoToViewer = function onGoToViewer(event) {
  event.preventDefault();
  viewState = 0;
  store.viewState = 0;
  $('#update-lab').hide();
  ...
  var id = store.currentCreatureId;
  onShowFromSearch(id);
};

var createCreatureObject = {
  'creature': {
    'user_id': '',
    'name': ''
  }
...
var onCreateCreature = function onCreateCreature(event) {
  event.preventDefault();
  ...
  api.createCreature(createCreatureObject).then(ui.createCreatureSuccess).catch(ui.createCreatureFail);
};

var onUpdateCreature = function onUpdateCreature(event) {
  event.preventDefault();
  ...
  api.updateCreature(updateCreatureObject, id).then(ui.updateCreatureSuccess).catch(ui.updateCreatureFail);
};

var onGetCreatures = function onGetCreatures(event) {
  event.preventDefault();

  api.getCreatures().then(ui.getCreaturesSuccess).catch(ui.getCreaturesFail);
};

var onShowCreature = function onShowCreature(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log('data is ' + data)
  // console.log('data is also ' + JSON.stringify(data, null, 4))

  api.showCreature(data).then(ui.showCreatureSuccess).catch(ui.showCreatureFail);
};

var onShowFromSearch = function onShowFromSearch(searchResult) {
  var data = { 'id': searchResult };

  api.showCreature(data).then(ui.showCreatureSuccess).catch(ui.showCreatureFail);
};

var onShowFromPublicSearch = function onShowFromPublicSearch(searchResult) {
  // console.log('searchResult is ', searchResult)
  var data = { 'id': searchResult };

  api.showPublicCreature(data).then(ui.showPublicCreatureSuccess).catch(ui.showPublicCreatureFail);
};

var onDeleteCreature = function onDeleteCreature(event) {
  event.preventDefault();
  var id = store.currentCreatureId;

  api.deleteCreature(id).then(ui.deleteCreatureSuccess).catch(ui.deleteCreatureFail);
};

var instructionsModal = document.getElementById('instructions-modal');
var labInstructionsButton = document.getElementById('lab-instructions-button');
...
var viewerInstructionsModal = document.getElementById('viewer-instructions-modal');
var viewerInstructionsButton = document.getElementById('viewer-instructions-button');
var closeViewerModal = document.getElementsByClassName('close')[1];
...
var creatureDisplayList = ['display-name', 'display-cr', 'display-alignment', 'display-creature_category', 'display-subcategory', 'display-size', 'display-initiative', 'display-senses', 'display-perception', 'display-languages', 'display-skills', 'display-str', 'display-dex', 'display-con', 'display-int', 'display-wis', 'display-cha', 'display-items', 'display-appearance', 'display-description', 'display-environment', 'display-organization', 'display-treasure', 'display-source', 'display-ac', 'display-dodgeac', 'display-flat_footed', 'display-ac_notes', 'display-cmd', 'display-saves', 'display-hp', 'display-hd', 'display-dr', 'display-fast_healing_regen', 'display-immunities', 'display-resistances', 'display-sr', 'display-weaknesses', 'display-defensive_abilities', 'display-speed', 'display-speed_note', 'display-melee', 'display-ranged', 'display-cmb', 'display-reach', 'display-offense_note', 'display-special_abilities', 'display-spell_like_abilities', 'display-spells_known', 'display-spells_prepared', 'display-feats', 'display-additional_special_qualities'];

var emptyArrayList = ['', 'CR:', ',', ',', ',', 'Size: ', 'Initiative: +null', 'Senses: ', 'Perception: ,', 'Languages: ', 'Skills: ', 'Str: ,', 'Dex: ,', 'Con: ,', 'Int: ,', 'Wis: ,', 'Cha: ', 'Items: ', 'Appearance: ', 'Description: ', 'Environment: ', 'Organization: ', 'Treasure: ', 'Source: null', 'AC: ,', 'Touch: null', 'Flat-Footed: null', 'Notes: ', 'CMD: ', 'Saves: ', 'HP: null', 'HD: ', 'DR: ', 'Healing Abilities: ', 'Immunities: ', 'Resistances: ', 'SR: null', 'Weaknesses: ', 'Defensive Abilities: ', 'Speed: ', 'Speed Note: null', 'Melee: ', 'Ranged: ', 'CMB: ', 'Reach: ', 'Offense Note: ', 'Special Abilities: ', '', 'Spells Known: ', 'Spells Prepared: ', 'Feats: ', 'Additional Special Qualities: '];
...
var createCreatureSuccess = function createCreatureSuccess(createCreatureResponse) {
...
var createCreatureFail = function createCreatureFail() {
...
var updateCreatureSuccess = function updateCreatureSuccess(updateCreatureResponse) {
...
var updateCreatureFail = function updateCreatureFail() {
...
var getCreaturesSuccess = function getCreaturesSuccess(getCreaturesResponse) {
  // console.log('getCreaturesResponse is ', getCreaturesResponse)
};

var getCreaturesFail = function getCreaturesFail() {
  // console.log('getCreaturesFail is ', error)
};

var showCreatureSuccess = function showCreatureSuccess(showCreatureResponse) {
  ...
  for (var i = 0; i < creatureDisplayList.length; i++) {
  ...
  if (document.getElementById('display-appearance').innerHTML.includes('null') && document.getElementById('display-description').innerHTML.includes('null') && document.getElementById('display-environment').innerHTML.includes('null') && document.getElementById('display-organization').innerHTML.includes('null') && document.getElementById('display-treasure').innerHTML.includes('null')) {
    $('#show-details-div').hide();
  } else if (document.getElementById('display-appearance').innerHTML === 'Appearance: ' && document.getElementById('display-description').innerHTML === 'Description: ' && document.getElementById('display-environment').innerHTML === 'Environment: ' && document.getElementById('display-organization').innerHTML === 'Organization: ' && document.getElementById('display-treasure').innerHTML === 'Treasure: ') {
    $('#show-details-div').hide();
  } else {
...
var showCreatureFail = function showCreatureFail() {
  // console.log('showCreatureFail is ', error)
  $('.display-creature').hide();
};

var showPublicCreatureSuccess = function showPublicCreatureSuccess(showPublicCreatureResponse) {
  ...
  try {
    for (var _iterator = Object.keys(showPublicCreatureResponse.public_creature)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var key = _step.value;
...
var showPublicCreatureFail = function showPublicCreatureFail() {
  // console.log('showCreatureFail is ', error)
  $('.display-creature').hide();
};

var deleteCreatureSuccess = function deleteCreatureSuccess(deleteCreatureResponse) {
...
var deleteCreatureFail = function deleteCreatureFail() {
...
var createCreature = function createCreature(createCreatureObject) {
...
var getCreatures = function getCreatures() {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + '/creatures',
    headers: {
...
var showCreature = function showCreature(data) {
  return $.ajax({
    method: 'GET',
...
var updateCreature = function updateCreature(updateCreatureObject, id) {
  return $.ajax({
    method: 'PATCH',
...
var deleteCreature = function deleteCreature(id) {
  return $.ajax({
    method: 'DELETE',
    url: config.apiUrl + '/creatures/' + id,
    headers: {
...
var getPublicCreatures = function getPublicCreatures() {
  return $.ajax({
    method: 'GET',
...
var showPublicCreature = function showPublicCreature(data) {
  return $.ajax({
    method: 'GET',
...
var publicSearch = __webpack_require__(12);
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://safe-ocean-44449.herokuapp.com/',
...
var onClick = function onClick(event) {
  ...
  api.getCreatures().then(onSearch).catch(ui.getCreaturesFail);
};

var onSearch = function onSearch(onClickData) {
  // console.log('onClickData is ', onClickData)
  // console.log('The list is ', onClickData.creatures)
  store.creatures = onClickData.creatures;
  var creaturesArray = onClickData.creatures;
  ...
  var searchListener = document.getElementById('search-input');
...
//
var onResultClick = function onResultClick(event) {
  var chosenMonster = event.target.innerHTML;
  ...
  var monsterIndex = store.creaturesList.indexOf(chosenMonster);
  // console.log('monsterIndex is ' + monsterIndex)
  // console.log('The database index is ' + store.creatures[monsterIndex].id)
  var monsterDatabaseIndex = store.creatures[monsterIndex].id;
...
var searchElement = document.getElementById('result-list');
...
var publicCreatures = [];
var publicCreaturesList = [];
var publicCreaturesString = '';

var onLoad = function onLoad(event) {
  api.getPublicCreatures().then(function (response) {
    publicCreatures = response.public_creatures;
    // console.log('publicCreatures is ', publicCreatures)
    for (var i = 0; i < publicCreatures.length; i++) {
...
$('#public-search-input').keyup(function () {
  ...
  var resultList = document.querySelector('#public-result-list');
  resultList.innerHTML = '';
  if (!search) {
    resultsText.val('');
    resultsCount.val('0');
  ...
  for (var _i2 = 0; _i2 < resultsArray.length; _i2++) {
    if (resultsArray[_i2]) {
      resultList.innerHTML += '<li class="list-group-item">' + resultsArray[_i2] + '</li>';
    }
  }
...
var onResultClick = function onResultClick(event) {
  ...
  // console.log('store.creatures is ' + store.creatures)
  // console.log('store.creaturesList is ' + store.creaturesList)
  var publicMonsterIndex = publicCreaturesList.indexOf(chosenMonster);
  // console.log('monsterIndex is ' + monsterIndex)
  // console.log('The database index is ' + store.creatures[publicMonsterIndex].id)
  var publicMonsterDatabaseIndex = publicCreatures[publicMonsterIndex].id;
...
var searchElement = document.getElementById('public-result-list');
...
module.exports = __webpack_require__.p + "34429cabe6ebb4c1f8c2a96663fea0ce.jpg";
