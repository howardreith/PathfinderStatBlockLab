...
const onSearch = function (onClickData) {
  ...
  console.log('The first one is ', onClickData.creatures[0])
}
...
// This is the listener for typing in the search box
const el = document.getElementById('search-input')
el.addEventListener('keyup', function (value, callback) {
  updateResult(this.value)
})
// updateResult(el.value))
// console.log('el is ' + JSON.stringify(el.value, null, 4))
